...
<head>
  ...
  <title>GiggleZen — Client Login</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Poppins', sans-serif; }
    ...
    @media (max-width: 850px) {
      #loginPage { flex-direction: column; max-width: 95%; }
...
<body>
  <div id="loginPage">
    ...
    <div class="form-section">
      <h2>Login to Client Dashboard</h2>
      <?php if($error): ?>
        <div style="background: rgba(255,0,0,0.2); color:#ffcccc; padding:10px; border-radius:8px; text-align:center; margin-bottom:15px;">
      ...
      <form id="loginForm" method="POST">
        ...
        <div class="form-check" >
          <a href="../ass-dashboard/index.php">
          <label style="color:red; text-decoration:solid;">Associate login</label>
          </a>
        </div>
        <button type="submit" class="submit-login">
          <span class="button-text">Access Now</span>
          <span class="loading-icon" style="display: none;"><i class="bi bi-arrow-repeat spin"></i></span>
        </button>
      </form>
    </div>
  </div>
